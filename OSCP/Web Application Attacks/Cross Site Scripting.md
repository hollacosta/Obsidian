[XSS Tools - HackTricks](https://book.hacktricks.xyz/pentesting-web/xss-cross-site-scripting/xss-tools)3
Stored or Reflected

The most common special characters used for XSS:
...
##**COMPRESSED JAVA using jscompress.com**
...
Use the tun0 ip address

┌──(hollacosta㉿kali1)-[~]
└─$ wpscan --url http://offsecwp/                                     ---to find the proper wpscan
